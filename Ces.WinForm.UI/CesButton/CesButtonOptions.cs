namespace Ces.WinForm.UI.CesButton
{
    public static class CesButtonOptions
    {
        static CesButtonOptions()
        {
            ...
            CesButtonColorTemplate.Add(ColorTemplateEnum.White, new TemplateProperty { TextColor = Color.Black, NormalColor = Color.White, MouseOverColor = Color.WhiteSmoke, MouseDownColor = Color.Silver, BorderColor = Color.White });
