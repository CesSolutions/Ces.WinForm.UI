namespace Ces.WinForm.UI.Infrastructure
{
    public static class Location
    {
        ...
        /// <summary>
        /// این متد فقط برای نمایش منوی فیلترینگ در گرید می باشد
        /// </summary>
        /// <param name="frm"></param>
        /// <param name="popupSize"></param>
        /// <param name="originalPoint"></param>
        /// <returns></returns>
        internal static Form GridViewPopupLocation(
            this Form frm,
            Size popupSize,
            Point originalPoint,
            int columnHeight)
        {
            ...
            var popupRightLocation = 0;
            var popupLeftLocation = 0;
            var comboLocation = originalPoint; //موقعیت هدر در مانیتور
            var popupBottomLocation = comboLocation.Y + frm.Height; //موقعیت پایین منوی باز شونده
            var popupTopLocation = comboLocation.Y - frm.Height; //موقعیت بالای منوی بازشونده
            var topSpace = comboLocation.Y; //فاصله لبه بالایی کنترل تا لبه بالایی مانیتور
            var bottomSpace = screenSize.Height - comboLocation.Y;
            ...
            else
            {
                ...
                else
                {
                    ...
                    //اگر قرار باشد منوی فیلتریمگ بدلیل کمبود فضا در یالای گرید 
                    //باز شود باید ارتفاع هدر هم محاسیه شود ولی این موضوع برای
                    //مواقعی که منو در حالت عادی زیر هدر باز می‌شود ضروری نیست
                    frm.Top = comboLocation.Y - frm.Height - columnHeight;
                }
            }
